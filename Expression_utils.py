...
class OperatorNode:
    def __init__(self,operator,operators,arity,parent=None):
        """
        operator:sequence[0]序列第一个操作符
        operators:
        arity:operators.arity_i(sequence[0]) 序列第一个操作符次数
        """
    ...
    def add_child(self,node):
        if (self.left_child is None):
            ...
            return RuntimeError("Both childnode have been created")
