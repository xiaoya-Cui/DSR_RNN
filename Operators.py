...
class Operators:
    ...
    def __init__(self, operator_list, device):
        ...
        # 定义属性
        self.arity_dict = dict(Operators.nonvar_arity, **{x: 0 for x in self.var_operators}, **{x: 0 for x in self.constant_operators})
    ...
    def __check_operator_list(self):
        #检查 使用的operator_list里面的操作符是否在定义中
